...
| 5b | **Phase 4 panel selection**: the app's own pipeline on library candidates, to find 40 held-out households where it survives 75-95% | 5d | ~1 h | Thu ~03:30 |
