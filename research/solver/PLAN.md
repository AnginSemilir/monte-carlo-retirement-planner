...
|---|---|---|---|
| 25 Sep 07:59 | **O22's trace (7j) read against its prediction: FALSIFIED - on S360 the exact final year changes nothing, and the 2-point gain from 15 return points is the earlier years' averaging, at the bridge cliff** (the batch launched 07:00:49 UK at 3deb82d, the last record 07:53:34 UK; reduce-o22.mjs's gate passed on all four pairings, each differing only in its one line; the prediction's Changes section was edited after the launch, declared there). The check: q5 and q15 reproduce 7i's S360 line exactly (0.8 / 34.4 and 2.4 / 36.4, net 20 of 22). Item 1 (the exact final year raises survival at 5 points): MISSED - +0.00 +/- 0.00, net 0 of 0. Item 2 (15 points within two se of 5 with the final year exact): MISSED - +2.00 +/- 0.47, net 20 of 22. The falsifier fired: the earlier years' averaging matters on S360. Descriptive, not an item (results-o22-detail.txt): every one of the 22 paths the two runs disagree on fails in year 6 or 7 - the last two years before S360's pension access at 58 - with 98-100% of its wealth in the pension; on 19 of the 21 saved paths the runs match in every earlier year, and in the failure year the 15-point run spends at the floor and survives while the 5-point run fails; the exact final year changed 3 and 2 path-years of 46000 | 7j done; O22 answered as far as registered, its cause at the bridge cliff NOT CHECKED; 7e runs S360 at 5 and 15 points with the reader (if the reader closes the gap, it was the misread; if not, the template-integral averaging returns, 7j's registered consequence); the exact final year: no harm and no effect on S360 (for 7k) | results: results-o22.txt, results-o22-detail.txt; fair-test: pass (reduce-o22.mjs's gate on each pairing's ran lines); prediction: predictions/o22-trace.md |
