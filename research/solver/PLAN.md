...
| 8j | **The scorecard**: each prediction item's credence against its outcome, the Brier score per test and in all, a reliability table; 7e is its first entry | - | build, no cores | before 7e is read |
