...
# (`audit-s126.mjs f1v2`, which solves through solvePlan, the product's entry). Twenty cases - the twelve S126 variants,
# then S120 S122 S124 S128 S130 S360 S366 S370 - split four ways (every fourth case from the k-th), 16 points, 1,000 held
