...
REQUIRED=(restyle-regression phone phone-perf desktop-reach sandbox-step simple-extras mc-reveal crossover production-build tradeoffs priorities simple-closecall tournament)
